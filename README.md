...
*   **AI/Orchestration:** Python (Agno) for image recognition (identifying monsters from screenshots to auto-navigate) and agentic workflow management.
...
*   **Python AI Service Placeholder:** A basic Flask application is set up with an endpoint `/identify-monster` that simulates image recognition (currently returns a dummy monster name). This serves as the initial structure for integrating the Agno AI vision feature.
